...
#### DATE LAST MODIFIED: 2020-05-11 by rcw
...
N1comp <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==7)] > tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==1)]
length(which(N1comp==TRUE))/length(N1comp)
## then, the average difference with 95% CI
N1compNum <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==7)] - tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==1)]
mN1 <- mean(N1compNum)
qN1 <- quantile(N1compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater B80 for N2 2017 vs. N2 2010
N2comp <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==8)] > tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==2)]
length(which(N2comp==TRUE))/length(N2comp)
## then, the average difference with 95% CI
N2compNum <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==8)] - tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==2)]
mN2 <- mean(N2compNum)
qN2 <- quantile(N2compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater B80 for C1 2017 vs. C1 2010
C1comp <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==9)] > tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==3)]
length(which(C1comp==TRUE))/length(C1comp)
## then, the average difference with 95% CI
C1compNum <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==9)] - tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==3)]
mC1 <- mean(C1compNum)
qC1 <- quantile(C1compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater B80 for C2 2017 vs. C2 2010
C2comp <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==10)] > tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==4)]
length(which(C2comp==TRUE))/length(C2comp)
## then, the average difference with 95% CI
C2compNum <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==10)] - tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==4)]
mC2 <- mean(C2compNum)
qC2 <- quantile(C2compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater B80 for S1 2017 vs. S1 2010
S1comp <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==11)] > tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==5)]
length(which(S1comp==TRUE))/length(S1comp)
## then, the average difference with 95% CI
S1compNum <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==11)] - tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==5)]
mS1 <- mean(S1compNum)
qS1 <- quantile(S1compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater B80 for S2 2017 vs. S2 2010
S2comp <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==12)] > tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==6)]
length(which(S2comp==TRUE))/length(S2comp)
## then, the average difference with 95% CI
S2compNum <- tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==12)] - tidy_perf_groups_av$B80[which(tidy_perf_groups_av$species==6)]
mS2 <- mean(S2compNum)
qS2 <- quantile(S2compNum, probs = c(0.025,0.975))
...
N1comp <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==7)] > tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==1)]
length(which(N1comp==TRUE))/length(N1comp)
## then, the average difference with 95% CI
N1compNum <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==7)] - tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==1)]
mN1 <- mean(N1compNum)
qN1 <- quantile(N1compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater max_RGR for N2 2017 vs. N2 2010
N2comp <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==8)] > tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==2)]
length(which(N2comp==TRUE))/length(N2comp)
## then, the average difference with 95% CI
N2compNum <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==8)] - tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==2)]
mN2 <- mean(N2compNum)
qN2 <- quantile(N2compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater max_RGR for C1 2017 vs. C1 2010
C1comp <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==9)] > tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==3)]
length(which(C1comp==TRUE))/length(C1comp)
## then, the average difference with 95% CI
C1compNum <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==9)] - tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==3)]
mC1 <- mean(C1compNum)
qC1 <- quantile(C1compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater max_RGR for C2 2017 vs. C2 2010
C2comp <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==10)] > tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==4)]
length(which(C2comp==TRUE))/length(C2comp)
## then, the average difference with 95% CI
C2compNum <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==10)] - tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==4)]
mC2 <- mean(C2compNum)
qC2 <- quantile(C2compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater max_RGR for S1 2017 vs. S1 2010
S1comp <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==11)] > tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==5)]
length(which(S1comp==TRUE))/length(S1comp)
## then, the average difference with 95% CI
S1compNum <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==11)] - tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==5)]
mS1 <- mean(S1compNum)
qS1 <- quantile(S1compNum, probs = c(0.025,0.975))

# calculate how many iterations estimated greater max_RGR for S2 2017 vs. S2 2010
S2comp <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==12)] > tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==6)]
length(which(S2comp==TRUE))/length(S2comp)
## then, the average difference with 95% CI
S2compNum <- tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==12)] - tidy_perf_groups_av$max_RGR[which(tidy_perf_groups_av$species==6)]
mS2 <- mean(S2compNum)
qS2 <- quantile(S2compNum, probs = c(0.025,0.975))
